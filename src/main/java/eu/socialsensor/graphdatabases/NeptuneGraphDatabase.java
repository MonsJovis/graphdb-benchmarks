 ...
 * @author
 */
public class NeptuneGraphDatabase extends GraphDatabaseBase<Iterator<Vertex>, Iterator<Edge>, Vertex, Edge>
{
    public static final String INSERTION_TIMES_OUTPUT_PATH = "data/neptune.insertion.times";
        ...
        boolean batchLoading)
    {
        ...
        // storage.addProperty("hostname", bench.getNeptuneHostname()); // FIXME not working
